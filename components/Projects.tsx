                    ...
                    >
                        ...
                        >
                            <Link href={`/projects/${project.slug}`} aria-label={`View project: ${project.title}`}>
                                <Card className="group relative overflow-hidden border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 h-[400px] md:h-[500px] cursor-pointer hover:border-rose-500/50 transition-colors rounded-xl">
                                    ...
                                    {/* Glassmorphism halo border overlay */}
